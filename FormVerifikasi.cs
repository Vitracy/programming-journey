            ...
            if (double.TryParse(textBox_tiket_id.Text, out double id))
            {
                ...
                using (MySqlConnection conn = new MySqlConnection(koneksi))
                {
                    ...
                    if (rd.Read())
                    {
                        ...
                        lbl_informasi.Text += rd["id"].ToString() ?? "";
                        lbl_informasi.Text += "\n\n# Informasi Pribadi";
                        lbl_informasi.Text += "\n • Nama Kontak: ";
                        lbl_informasi.Text += rd["nama_kontak"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Tanggal lahir: ";
                        lbl_informasi.Text += rd["tanggal_lahir"].ToString() ?? "";
                        lbl_informasi.Text += "\n • E-mail: ";
                        lbl_informasi.Text += rd["email"].ToString() ?? "";
                        lbl_informasi.Text += "\n • No. Telp: ";
                        lbl_informasi.Text += rd["no_telp"].ToString() ?? "";

                        lbl_informasi.Text += "\n\n# Detail Perjalanan";
                        lbl_informasi.Text += "\n • Negara Keberangkatan: ";
                        lbl_informasi.Text += rd["negara_keberangkatan"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Negara Tujuan: ";
                        lbl_informasi.Text += rd["negara_tujuan"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Tanggal dan Waktu Keberangkatan: ";
                        lbl_informasi.Text += rd["tanggal_waktu_keberangkatan"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Kelas Layanan: ";
                        lbl_informasi.Text += rd["kelas_layanan"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Layanan Lainnya: ";
                        lbl_informasi.Text += rd["layanan_lainnya"].ToString() ?? "";

                        lbl_informasi.Text += "\n\n# Rincian Perjalanan";
                        if (!string.IsNullOrEmpty(rd["hotel_pilihan"].ToString()))
                        {
                            lbl_informasi.Text += "\n • Hotel Pilihan: ";
                            lbl_informasi.Text += rd["hotel_pilihan"].ToString() ?? "";
                        }
                        lbl_informasi.Text += "\n • Penerbangan Pilihan: ";
                        lbl_informasi.Text += rd["penerbangan_pilihan"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Informasi Tambahan: ";
                        lbl_informasi.Text += rd["informasi_tambahan"].ToString() ?? "";
                        lbl_informasi.Text += "\n • Harga Tiket: ";
                        lbl_informasi.Text += "Rp. " + FormatMoney(Convert.ToInt32(rd["harga_tiket"]));
